...
\section{Work Experience}
  \resumeSubHeadingListStart
	\resumeSubheading
      ...
      {Machine Learning Engineer, Therap Innovation Lab}{Oct 2019 - Present}
      \resumeItemListStart
		\resumeItem{Responsibilities}{
			\begin{itemize}
				\item Lead the newly established ML effort at Therap.
				\item Create a team from the ground up by hiring and training new talent.
				\item Explore the business potential in the analysis and inference of real-time time-series sensor data received from IoT devices.
			\end{itemize}			
		}      
		
        \resumeItem{Related Technologies}
          {Python, Numpy, Pandas, Matplotlib, Seaborn, Scikit-Learn, Keras, TensorFlow}
      \resumeItemListEnd

    \resumeSubheading
      {Therap (BD) Ltd.}{Dhaka, Bangladesh}
      {Software Engineer, System Architecture Team}{Oct 2016 - Oct 2019}
      \resumeItemListStart
		\resumeItem{Responsibilities}{
			\begin{itemize}
			...
			\resumeItemListStart
				...
				\resumeItem{Outcome}{
					\begin{itemize}
						...
						\item My AI system improved existing customer service representative output by 3x allowing X to meet market demand keeping existing infrastructure intact.
