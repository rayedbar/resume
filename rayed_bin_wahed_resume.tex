      ...
      \resumeItemListStart
		...
		\resumeItem{Core Responsibilities}{
			\begin{itemize}
				...
				\item I play for the Therap football team and voluntarily participate in scheduling practice mathches and organizing transportation.
			\end{itemize}			
		}      
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      	\resumeItem{Objectives}{
			...
			\begin{itemize}
				\item Investigate the training time and prediction accuracy of Google's Inception-v3 Deep Neural Network (DNN) architecture to popular variants of Support Vector Machines (SVM) and a Convolutional Neural Network (CNN) model of our own design.
...
\section{Programming Skills}
  \resumeSubHeadingListStart
  	\resumeSubItem{Languages}{Java, JavaScript, Python, Keras, TensorFlow, Numpy, Pandas, Matplotlib, SciPy, Pytorch}
  \resumeSubHeadingListEnd
