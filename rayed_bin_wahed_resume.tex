      ...
      \resumeItemListStart
		...
		\resumeItem{Core Responsibilities}{
			\begin{itemize}
				...
				\item Thorough understanding of RDBMS (Relational Database Management System) and a demonstrated ability in database design using SQL.
     ...
     {Teaching Assistant}{Jan 2014 - Aug 2016}
      \resumeItemListStart
       \resumeItem{Data Structures and Discrete Mathematics}{
			\begin{itemize}
				\item Graded quizzes.
				\item Provided one-to-one consultations and exam hall invigilation.
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
		...
		\resumeItem{Course 5: Sequence Models}{
			...
			\end{itemize}Google Cloud Training
		}
      \resumeItemListEnd
