      ...
      \resumeItemListStart
		\resumeItem{Responsibilities}{
			\begin{itemize}
				...
				\item Implemented REST end-points for common resources to be used internally by other modules and our mobile application.
			\end{itemize}			
		}      
