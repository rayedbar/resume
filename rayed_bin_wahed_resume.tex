...
\resumeSubheading
      ...
      \resumeItemListStart
		...
		\resumeItem{Face Recognition}{Implemented a face recognition model to identify and track unauthorized individuals from a video feed. Desinged to enforce HIPAA, the model has an accuracy of 99\%.}
